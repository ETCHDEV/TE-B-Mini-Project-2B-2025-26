        ...
        <motion.div key={s.id} initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.25 }}>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-display text-2xl font-bold text-accent">
                      {(aiP.weeklyPlan && aiP.weeklyPlan.length > 0) ? aiP.weeklyPlan.length : aiP.estimatedReadinessWeeks} weeks
                    </p>
                  </div>
                </div>
              </CyberCard>
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            ...
            <CyberCard variant="glow" delay={0.25}>
              ...
              <div className="mt-5">
                <CyberButton variant="ghost" size="sm" onClick={() => navigate('/tracks')} className="w-full min-w-[100px]">
            ...
            <CyberCard delay={0.3}>
              <div className="flex items-center gap-3 mb-5">
               ...
               <div className="space-y-3">
                {aiP ? (
                  (aiP.recommendations || []).map((rec, i) => (
                    <motion.div key={rec} initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 + i * 0.08 }}
