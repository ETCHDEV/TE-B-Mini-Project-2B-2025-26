...
const TPOUsersManagement = () => {
  ...
  const handleSetRole = async (targetUserId: string, newRole: 'student' | 'tpo') => {
    ...
    try {
      console.log('Updating role for user:', targetUserId, 'to', newRole);
      ...
      <div className="min-h-screen relative grid-pattern">
        ...
        <div className="relative z-10 container mx-auto px-4 pt-24 pb-12 flex items-center justify-center min-h-[60vh]">
          <CyberCard variant="glow" className="text-center max-w-md">
            ...
            <h3 className="font-display text-xl font-bold mb-2">Loading Users</h3>
  ...
  if (error) {
    return (
      <div className="min-h-screen relative grid-pattern">
        <CursorGlow color="destructive" size={250} />
        <Navbar />
        <div className="relative z-10 container mx-auto px-4 pt-24 pb-12 flex items-center justify-center min-h-[60vh]">
          <CyberCard variant="glow" className="text-center max-w-md">
            <div className="w-16 h-16 rounded-full bg-destructive/20 border border-destructive/50 flex items-center justify-center mx-auto mb-4">
              <XCircle className="w-8 h-8 text-destructive" />
            </div>
            <h3 className="font-display text-xl font-bold mb-2">Error Loading Users</h3>
            <p className="text-muted-foreground text-sm mb-4">
              {error}
            </p>
            <CyberButton onClick={fetchUsers} className="w-full min-w-[120px]">
