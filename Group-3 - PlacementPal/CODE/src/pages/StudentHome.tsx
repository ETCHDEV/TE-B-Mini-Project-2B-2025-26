      ...
      <div className="relative z-10 container mx-auto px-4 pt-24 pb-12">
        ...
        >
          ...
          >
            {[
              ...
              { icon: BarChart3, value: 'ML', label: 'Skill Analysis' },
              { icon: Zap, value: '90 min', label: 'Per Assessment' },
            ].map((stat, i) => (
            ...
            <div className={`grid gap-4 max-w-5xl mx-auto ${
              ...
              {domainProgress.length < 4 && (
                ...
                >
                  <button
                    onClick={() => navigate('/tracks')}
                    className="w-full h-full min-h-[200px] p-5 rounded-lg border border-dashed border-border hover:border-primary/50 bg-muted/20 hover:bg-primary/5 transition-all duration-300 flex flex-col items-center justify-center gap-3 group min-w-[160px]"
                  >
        ...
        >
          <CyberCard variant="glow" className="max-w-4xl mx-auto text-center py-12 px-8">
            ...
            <CyberButton variant="primary" size="lg" glowing onClick={() => navigate('/tracks')}>
              <Target className="w-5 h-5 mr-2" />
