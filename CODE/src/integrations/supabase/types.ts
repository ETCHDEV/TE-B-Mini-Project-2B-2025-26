...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      get_assessment_stats: { Args: {}; Returns: Json[] }
      get_recent_assessments: { Args: { limit_count: number }; Returns: Json[] }
      admin_get_users: { Args: {}; Returns: Json[] }
    }
    Enums: {
